...
namespace RemotePatientCareInterface
{
    public partial class Form1 : Form
    {
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if (currentButton != (Button)btnSender)
                {
                    ...
                    currentButton.BackColor = currentButton.FlatAppearance.MouseOverBackColor;
        ...
        {
            ActivateButton(sender);
            OpenChildForm(new Forms.SerumForm());
        }

        private void Light_Click(object sender, EventArgs e)
        {
            ActivateButton(sender);
            OpenChildForm(new Forms.LightForm());
        }

        private void Temp_Click(object sender, EventArgs e)
        {
            ActivateButton(sender);
            OpenChildForm(new Forms.TempForm());
        }

        private void Motion_Click(object sender, EventArgs e)
        {
            ActivateButton(sender);
            OpenChildForm(new Forms.MotionForm());
        }
